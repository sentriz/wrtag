...
| `COMPOSER`                   | Concatenated composers on the recording                | `Artist One, Artist Two`                                                                                                                                                                                                     |
| `COMPOSERS`                  | multi-valued composers on the recording                | `Artist One`, `Artist Two`                                                                                                                                                                                                   |
| `COMPOSER_CREDIT`            | Concatenated composers on the recording, credited name | `artist.one, artist.two`                                                                                                                                                                                                     |
| `COMPOSERS_CREDIT`           | multi-valued composers on the recording, credited name | `artist.one`, `artist.two`                                                                                                                                                                                                   |
