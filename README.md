...
| `REMIXER_CREDIT`             | Concatenated remixers on the recording, credited name | `DJ Artist One, DJ Artist-Two`                                                                                                                                                                                               |
| `REMIXERS_CREDIT`            | multi-valued remixers on the recording, credited name | `DJ Artist One`, `DJ Artist-Two`                                                                                                                                                                                             |
