...
7. [Tagging](#tagging)
   ...
   - [Tags kept by default](#tags-kept-by-default)
...
```
/music/{{ artists .Release.Artists | sort | join "; " | safepath }}/({{ .Release.ReleaseGroup.FirstReleaseDate.Year }}) {{ .Release.Title | safepath }}{{ with disambiguation .Release }} ({{ . | safepath }}){{ end }}/{{ pad0 2 .Track.Position }} {{ .Track.Title | safepath }}{{ .Ext }}
```

### With compilation handling

```
/music/{{ artists .Release.Artists | sort | join "; " | safepath }}/({{ .Release.ReleaseGroup.FirstReleaseDate.Year }}) {{ .Release.Title | safepath }}/{{ pad0 2 .Track.Position }} {{ if isCompilation .Release.ReleaseGroup }}{{ artistsString .Track.Artists | safepath }} - {{ end }}{{ .Track.Title | safepath }}{{ .Ext }}
```
...
| `REMIXER_CREDIT`             | Concatenated remixers on the recording, credited name     | `artist.one, artist.two`                                                                                                                                                                                                     |
| `REMIXERS_CREDIT`            | multi-valued remixers on the recording, credited name     | `artist.one`, `artist.two`                                                                                                                                                                                                   |
| `MUSICBRAINZ_REMIXERID`      | MusicBrainz remixer artist IDs                            | `ff95eb47-41c4-4f7f-a104-cdc30f02e872`, `d4659efb-b8eb-4f03-95e9-f69ce35967a9`                                                                                                                                               |
| `PRODUCER`                   | Concatenated producers on the recording                   | `Artist One, Artist Two`                                                                                                                                                                                                     |
| `PRODUCERS`                  | multi-valued producers on the recording                   | `Artist One`, `Artist Two`                                                                                                                                                                                                   |
| `PRODUCER_CREDIT`            | Concatenated producers on the recording, credited name    | `artist.one, artist.two`                                                                                                                                                                                                     |
| `PRODUCERS_CREDIT`           | multi-valued producers on the recording, credited name    | `artist.one`, `artist.two`                                                                                                                                                                                                   |
| `MUSICBRAINZ_PRODUCERID`     | MusicBrainz producer artist IDs                           | `ff95eb47-41c4-4f7f-a104-cdc30f02e872`, `d4659efb-b8eb-4f03-95e9-f69ce35967a9`                                                                                                                                               |
| `CONDUCTOR`                  | Concatenated conductors on the recording                  | `Artist One, Artist Two`                                                                                                                                                                                                     |
| `CONDUCTORS`                 | multi-valued conductors on the recording                  | `Artist One`, `Artist Two`                                                                                                                                                                                                   |
| `CONDUCTOR_CREDIT`           | Concatenated conductors on the recording, credited name   | `artist.one, artist.two`                                                                                                                                                                                                     |
| `CONDUCTORS_CREDIT`          | multi-valued conductors on the recording, credited name   | `artist.one`, `artist.two`                                                                                                                                                                                                   |
| `MUSICBRAINZ_CONDUCTORID`    | MusicBrainz conductor artist IDs                          | `ff95eb47-41c4-4f7f-a104-cdc30f02e872`, `d4659efb-b8eb-4f03-95e9-f69ce35967a9`                                                                                                                                               |
| `COMPOSER`                   | Concatenated composers on the related work                | `Artist One, Artist Two`                                                                                                                                                                                                     |
| `COMPOSERS`                  | multi-valued composers on the related work                | `Artist One`, `Artist Two`                                                                                                                                                                                                   |
| `COMPOSER_CREDIT`            | Concatenated composers on the related work, credited name | `artist.one, artist.two`                                                                                                                                                                                                     |
| `COMPOSERS_CREDIT`           | multi-valued composers on the related work, credited name | `artist.one`, `artist.two`                                                                                                                                                                                                   |
| `MUSICBRAINZ_COMPOSERID`     | MusicBrainz composer artist IDs                           | `ff95eb47-41c4-4f7f-a104-cdc30f02e872`, `d4659efb-b8eb-4f03-95e9-f69ce35967a9`                                                                                                                                               |
| `LYRICIST`                   | Concatenated lyricists on the related work                | `Artist One, Artist Two`                                                                                                                                                                                                     |
| `LYRICISTS`                  | multi-valued lyricists on the related work                | `Artist One`, `Artist Two`                                                                                                                                                                                                   |
| `LYRICIST_CREDIT`            | Concatenated lyricists on the related work, credited name | `artist.one, artist.two`                                                                                                                                                                                                     |
| `LYRICISTS_CREDIT`           | multi-valued lyricists on the related work, credited name | `artist.one`, `artist.two`                                                                                                                                                                                                   |
| `MUSICBRAINZ_LYRICISTID`     | MusicBrainz lyricist artist IDs                           | `ff95eb47-41c4-4f7f-a104-cdc30f02e872`, `d4659efb-b8eb-4f03-95e9-f69ce35967a9`                                                                                                                                               |
| `ARRANGER`                   | Concatenated arrangers on recording/work                  | `Artist One, Artist Two`                                                                                                                                                                                                     |
| `ARRANGERS`                  | multi-valued arrangers on recording/work                  | `Artist One`, `Artist Two`                                                                                                                                                                                                   |
| `ARRANGER_CREDIT`            | Concatenated arrangers on recording/work, credited name   | `artist.one, artist.two`                                                                                                                                                                                                     |
| `ARRANGERS_CREDIT`           | multi-valued arrangers on recording/work, credited name   | `artist.one`, `artist.two`                                                                                                                                                                                                   |
| `MUSICBRAINZ_ARRANGERID`     | MusicBrainz arranger artist IDs                           | `ff95eb47-41c4-4f7f-a104-cdc30f02e872`, `d4659efb-b8eb-4f03-95e9-f69ce35967a9`                                                                                                                                               |
| `ENGINEER`                   | Concatenated engineers on the recording                   | `Artist One, Artist Two`                                                                                                                                                                                                     |
| `ENGINEERS`                  | multi-valued engineers on the recording                   | `Artist One`, `Artist Two`                                                                                                                                                                                                   |
| `ENGINEER_CREDIT`            | Concatenated engineers on the recording, credited name    | `artist.one, artist.two`                                                                                                                                                                                                     |
| `ENGINEERS_CREDIT`           | multi-valued engineers on the recording, credited name    | `artist.one`, `artist.two`                                                                                                                                                                                                   |
| `MUSICBRAINZ_ENGINEERID`     | MusicBrainz engineer artist IDs                           | `ff95eb47-41c4-4f7f-a104-cdc30f02e872`, `d4659efb-b8eb-4f03-95e9-f69ce35967a9`                                                                                                                                               |
| `PERFORMER`                  | Concatenated performers on the recording                  | `Artist One, Artist Two`                                                                                                                                                                                                     |
| `PERFORMERS`                 | multi-valued performers on the recording                  | `Artist One`, `Artist Two`                                                                                                                                                                                                   |
| `PERFORMER_CREDIT`           | Concatenated performers on the recording, credited name   | `artist.one, artist.two`                                                                                                                                                                                                     |
| `PERFORMERS_CREDIT`          | multi-valued performers on the recording, credited name   | `artist.one`, `artist.two`                                                                                                                                                                                                   |
| `MUSICBRAINZ_PERFORMERID`    | MusicBrainz performer artist IDs                          | `ff95eb47-41c4-4f7f-a104-cdc30f02e872`, `d4659efb-b8eb-4f03-95e9-f69ce35967a9`                                                                                                                                               |
| `WRITER`                     | Concatenated writers on the related work                  | `Artist One, Artist Two`                                                                                                                                                                                                     |
| `WRITERS`                    | multi-valued writers on the related work                  | `Artist One`, `Artist Two`                                                                                                                                                                                                   |
| `WRITER_CREDIT`              | Concatenated writers on the related work, credited name   | `artist.one, artist.two`                                                                                                                                                                                                     |
| `WRITERS_CREDIT`             | multi-valued writers on the related work, credited name   | `artist.one`, `artist.two`                                                                                                                                                                                                   |
| `MUSICBRAINZ_WRITERID`       | MusicBrainz writer artist IDs                             | `ff95eb47-41c4-4f7f-a104-cdc30f02e872`, `d4659efb-b8eb-4f03-95e9-f69ce35967a9`                                                                                                                                               |
| `WORK`                       | Titles of the related works                               | `America Is Waiting`                                                                                                                                                                                                         |
| `MUSICBRAINZ_WORKID`         | MusicBrainz work IDs                                      | [`a3b90098-15d0-467e-a6b8-e00c0ec1d93d`](https://musicbrainz.org/work/a3b90098-15d0-467e-a6b8-e00c0ec1d93d)                                                                                                                  |
